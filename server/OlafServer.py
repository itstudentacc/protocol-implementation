...
if __name__ == "__main__":
    ...
    HOST = os.getenv('HOST')
    EXTERNAL_ADDRESS = os.getenv('EXTERNAL_ADDRESS', 'localhost')
 
    ws_server = WebSocketServer(bind_address=BIND_ADDRESS, host=HOST, ws_port=WS_PORT, http_port=HTTP_PORT, neighbours_list=NEIGHBOURS)
